    ...
    <Container className={styles.section}>
      <Appear>
        ...
        <Typography className={styles.info}>
          “I’m really excited about eventflo and its vision for transforming the event industry. I'm right behind the
          project, actively guiding the team to ensure they deliver on their goals. I’m personally backing this
          initiative and getting my entire network on board. You can bet that my large-scale events will be among the
          first to benefit from this game changer.”
        </Typography>
